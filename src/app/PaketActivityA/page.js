        ...
        <div className="w-full md:w-full lg:mx-auto max-w-screen-xl p-4 mt-10">
          <div className="w-full flex justify-start">
            <div className="text-start text-4xl pb-[20%] md:pb-[6%] font-bold w-full text-[#171717]">
              Bali Jadma<span className="font-medium px-2">Tour</span>: Ayung
              River Rafting
            </div>
            <div></div>
          </div>
          ...
          <div className="py-8 grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="w-full">
              <div>
                Ayung river rafting rapid grade 2-3 level can be categories and
                suitable for those who never try rafting activities before.
                Professional instructor will go with you make sure of your
                safety and enjoy the adventure, Ayung river has 10 km route.
                It's about 2 hours rafting adventure. Passing through the
                magnificent nature. Lush green rain forest, very unique carve
                stone wall and beautiful waterfall Make your adventure
              ...
              <div className="">
                <div className="w-full">
                  <div className="py-6">
                    {/*  */}{" "}
                    <div className="text-lg font-semibold text-[#171717] pt-4">
                      Minimum 2 Person
                    </div>
                    <div className="pl-4">
                      <div className="grid items-center pt-2 ">
                        ...
                        <div className="py-4">
                          <div className="text-sm pb-2">Price Include</div>
                          <div className="text-md font-light grid items-center">
                            <li>Pick up and drop back to hotel</li>
                            <li>
                              Private transport with fully air conditioning car
                            </li>
                            <li>English speaking driver</li>
                            <li>Lunch</li>
                            <li>Safety International standard rafting</li>
                          </div>
                          {/* <div className="text-sm font-semibold text-[#171717] py-4">
                      ...
                      <div className="grid items-center ">
                        <div className="">
                          <div className="text-sm pb-2">Equipment:</div>
                          <div className="text-md font-light grid items-center pl-4">
                            <li>Professional river guide</li>
                            <li>
                              Insurance during river activities from the the age
                              6 years old - 65 years old
                            </li>
                            <li>Shower and changing rooms</li>
                            <li>Using towel</li>
                            <li>Waterproof bags</li>
                            <li>Welcome drink at start point</li>
                      ...
                      <div className="grid items-center pt-4">
                        <div className="">
                          <div className="text-sm pb-2">Restriction:</div>
                          <div className="text-md font-light grid items-center pl-4">
                            <div>
                              Doing rafting is not recommended for woman who
                              pregnant, or people with recent back bone problem
                              or neck injuries, heart problem, epilepsy or
                              asthma.
                            </div>
                          </div>
                        </div>
